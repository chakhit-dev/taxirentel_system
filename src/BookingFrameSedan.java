...
public class BookingFrameSedan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLayeredPane5.setBorder(javax.swing.BorderFactory.createTitledBorder("Booking"));
    ...
    private void loadBookingSedanInfor() {
        ...
        List<Booking> data = qm.fetchBookingAll();
    ...
    private void loadDriverID() {
        ...
        jComboBox2.addItem("SELECT");
            ...
            for(Booking bk : data) {
                //model.addRow(new Object[]{ts.getStartTime(), ts.getEndTime()});
                jComboBox2.addItem(bk.getDriver().getDriverID());
            }
    }
    ...
    private void loadModel() {
        ...
        jComboBox3.addItem("SELECT");
            ...
            for(Booking bk : data) {
                //model.addRow(new Object[]{ts.getStartTime(), ts.getEndTime()});
                jComboBox3.addItem(bk.getCar().getCarID());
            }
    }
    
    
    
    public void geneteratePDF() {
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        ...
        String checknulltext = jTextPane1.getText().toString();
        
        try {
                
            if (checknulltext != "") {
                String data = jTextPane1.getText().toString();
                String name_inv = jTextField1.getText().toString();


                String path = name_inv + "_invoice.pdf";
                PdfWriter pdfWriter;
                ...
                JOptionPane.showMessageDialog(this, "Invoice " + name_inv + " has created !");
            }
            else {
                JOptionPane.showMessageDialog(this, "Please select Booking ID !");
            }
       
        } catch (FileNotFoundException ex) {
            Logger.getLogger(BookingFrameSedan.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        List<Booking> data = qm.fetchBookingByID(getData);
        

        
        if (data != null){
            for(Booking bk : data) {
                jTextField1.setText(bk.getBookingID());
                String tp = "BOOKING ID : " + bk.getBookingID() +
                        "\n" + "Vehicle ID : " + bk.getCar().getCarID() +
                        "\nVehicle Model : " + bk.getCar().getModel() +
                        "\nVehicle Type : Sedan" +
                        "\nDRIVER ID : " + bk.getDriver().getDriverID() +
                        "\nDATE : " + bk.getDate() +
                        "\nTOTAL PRICE : " + bk.getCar().calculateFinalPrice();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int statusTime = qm.fetchTime(timenow);
        
        if (statusTime == 1) {
            String booking_id_gen = qm.generateBookingID();
        
            String dv_id = jComboBox2.getSelectedItem().toString();
            String ml_id = jComboBox3.getSelectedItem().toString();

            Booking bk = new Booking(booking_id_gen, null, null, null, null);

            int status = qm.insertBooking(bk, dv_id, ml_id);
            ...
            if(status == 1){
                ...
                loadDriverID();
                loadModel();
                JOptionPane.showMessageDialog(this, "Failed to added Booking !");
            }
        }
        else {
            JOptionPane.showMessageDialog(this, "You cannot BOOKING because it's not time yet!");
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        int status = qm.deleteBooking(getData);
        ...
        if(status == 1) {
            ...
            loadDriverID();
            loadModel();
            JOptionPane.showMessageDialog(this, "Booking Id " + getData + " has deleted");
        }
        else {
            JOptionPane.showMessageDialog(this, "Booking failed to delete !");
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String old_booking_id = jComboBox1.getSelectedItem().toString();
        
        String booking_id_up = jTextField1.getText().toString();
        String driver_id_up = jComboBox2.getSelectedItem().toString();
        String model_up = jComboBox3.getSelectedItem().toString();
        
        Booking bk = new Booking(old_booking_id, null, null, null, null);
        
        int status = qm.updateBooking(bk, booking_id_up, driver_id_up, model_up);
